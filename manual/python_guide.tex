...
\begin{lstlisting}[language=bash, caption={Installing the spectrograms package}]
pip install spectrograms
\end{lstlisting}

\begin{lstlisting}[language=Python, caption={Importing numpy and spectrograms}]
import numpy as np
...
\begin{lstlisting}[language=Python, caption={Catching spectrogram-specific exceptions}]
try:
...
\begin{lstlisting}[language=Python, caption={Computing a 1D FFT with Hermitian output}]
n_fft: int = 512
...
\begin{lstlisting}[language=Python, caption={Inverse FFT and reconstruction error check}]
...
\begin{lstlisting}[language=Python, caption={Power and magnitude spectra with windowing}]
...
\begin{lstlisting}[language=Python, caption={Selecting predefined window function types}]
...
\begin{lstlisting}[language=Python, caption={Parametric Kaiser and Gaussian windows}]
...
\begin{lstlisting}[language=Python, caption={Configuring STFT parameters and presets}]
...
\begin{lstlisting}[language=Python, caption={Power, magnitude, and dB linear spectrograms}]
...
\begin{lstlisting}[language=Python, caption={Accessing metadata from a Spectrogram object}]
...
\begin{lstlisting}[language=Python, caption={Computing mel-scale spectrograms}]
...
\begin{lstlisting}[language=Python, caption={Computing ERB-scale spectrograms}]
...
\begin{lstlisting}[language=Python, caption={Computing log-Hz spectrograms for music}]
...
\begin{lstlisting}[language=Python, caption={Computing CQT spectrograms}]
...
\begin{lstlisting}[language=Python, caption={Raw complex STFT with magnitude and phase extraction}]
...
\begin{lstlisting}[language=Python, caption={Inverse STFT reconstruction and error verification}]
stft_matrix: npt.NDArray[np.complex128] = sg.compute_stft(samples, params.stft)
...
\begin{lstlisting}[language=Python, caption={Computing MFCCs with liftering and DCT}]
...
\begin{lstlisting}[language=Python, caption={Computing pitch-class chromagram}]
...
\begin{lstlisting}[language=Python, caption={Reusing a mel-dB plan for batch processing}]
# Single computation
...
\begin{lstlisting}[language=Python, caption={All spectrogram plan types from SpectrogramPlanner}]
...
\begin{lstlisting}[language=Python, caption={Frame-by-frame spectrogram computation}]
planner = sg.SpectrogramPlanner()
...
\begin{lstlisting}[language=Python, caption={Streaming real-time frame extraction from buffer}]
planner = sg.SpectrogramPlanner()
plan = planner.mel_power_plan(params, mel_params)
...
\begin{lstlisting}[language=Python, caption={Forward 2D FFT with half-spectrum output}]
...
\begin{lstlisting}[language=Python, caption={Inverse 2D FFT and reconstruction error}]
spectrum = sg.fft2d(image)
...
\begin{lstlisting}[language=Python, caption={2D power and magnitude spectra with log scale}]
...
\begin{lstlisting}[language=Python, caption={FFT shift to centre the DC component}]
...
\begin{lstlisting}[language=Python, caption={Batch 2D FFT via Fft2dPlanner plans}]
...
\begin{lstlisting}[language=Python, caption={Gaussian blur via FFT convolution}]
...
\begin{lstlisting}[language=Python, caption={Low-pass, high-pass, and band-pass image filters}]
...
\begin{lstlisting}[language=Python, caption={FFT-based edge detection and image sharpening}]
# Edge detection
...
\begin{lstlisting}[language=Python, caption={WindowType constructors and variants}]
...
\begin{lstlisting}[language=Python, caption={StftParams constructor signature}]
stft = sg.StftParams(
    n_fft: int,
    hop_size: int,
...
\begin{lstlisting}[language=Python, caption={LogParams constructor for dB floor}]
db_params = sg.LogParams(floor_db: float)
\end{lstlisting}

\textbf{SpectrogramParams:}

\begin{lstlisting}[language=Python, caption={SpectrogramParams constructors and presets}]
...
\begin{lstlisting}[language=Python, caption={MelParams constructor with frequency range}]
...
\begin{lstlisting}[language=Python, caption={ErbParams constructor with gammatone option}]
...
\begin{lstlisting}[language=Python, caption={LogHzParams constructor with octave resolution}]
...
\begin{lstlisting}[language=Python, caption={CqtParams constructor with sparsity threshold}]
...
\begin{lstlisting}[language=Python, caption={ChromaParams constructor and music preset}]
...
\begin{lstlisting}[language=Python, caption={MfccParams constructor and speech preset}]
...
\begin{lstlisting}[language=Python, caption={All spectrogram compute function signatures}]
# Linear
...
\begin{lstlisting}[language=Python, caption={Audio feature compute function signatures}]
# STFT
...
\begin{lstlisting}[language=Python, caption={1D FFT and spectrum compute function signatures}]
# 1D FFT
...
\begin{lstlisting}[language=Python, caption={2D FFT function signatures and return types}]
# 2D FFT
...
\begin{lstlisting}[language=Python, caption={Image processing function signatures}]
# Convolution
